...
<template>
  <div class="course-page">
    <el-button type="primary" class="back-button" @click="handleBack">
      返回
    </el-button>

    <div class="section-intro">
      <div class="intro-image">
        <el-icon size="120" class="image-placeholder">
          <Document />
        </el-icon>
      </div>
    ...
    <div class="course-cards-container">
      ...
      <div class="course-cards">
        <el-card v-for="course in paginatedCourses" :key="course.id" class="course-card" :body-style="{ padding: '0' }"
          @click="handleCardClick(course)">
          <div class="course-card-content">
            <div class="course-card-image">
              <el-icon size="40" class="course-image-placeholder">
                <Document />
              </el-icon>
            </div>
      ...
      <div class="pagination-container">
        <el-pagination v-model:current-page="currentPage" :page-sizes="[5]" layout="total, prev, pager, next, jumper"
          :total="total" :page-count="totalPages" @size-change="handleSizeChange"

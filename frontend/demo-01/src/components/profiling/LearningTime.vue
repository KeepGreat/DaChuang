...
import LearningTrend from "@/components/profiling/learningtime/LearningTrend.vue";
import PracticeProgress from "@/components/profiling/learningtime/PracticeProgress.vue";
import StatCard from "@/components/profiling/learningtime/StatCard.vue";

import DifficultyAccuracy from "@/components/profiling/learningtime/DifficultyAccuracy.vue";
import EfficiencyTrend from "@/components/profiling/learningtime/EfficiencyTrend.vue";
import RadarStats from "@/components/profiling/learningtime/RadarStats.vue";
import StudyPunchCard from "@/components/profiling/learningtime/StudyPunchCard.vue";
import StudyTypeDistribution from "@/components/profiling/learningtime/StudyTypeDistribution.vue";
